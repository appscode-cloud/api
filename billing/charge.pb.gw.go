...
func request_Charge_Create_0(ctx context.Context, client ChargeClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ChargeCreateRequest
...
func RegisterChargeHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("PUT", pattern_Charge_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Charge_Create_0(runtime.AnnotateContext(ctx, req), client, req, pathParams)
		...
		forward_Charge_Create_0(ctx, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Charge_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "billing", "v0", "charge", "charge_type"}, ""))
)

var (
	forward_Charge_Create_0 = runtime.ForwardResponseMessage
)
