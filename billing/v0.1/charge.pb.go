...
func (*ChargeResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type ChargeClient interface {
	Calculate(ctx context.Context, in *dtypes.VoidRequest, opts ...grpc.CallOption) (*ChargeResponse, error)
}
...
func (c *chargeClient) Calculate(ctx context.Context, in *dtypes.VoidRequest, opts ...grpc.CallOption) (*ChargeResponse, error) {
...
type ChargeServer interface {
	Calculate(context.Context, *dtypes.VoidRequest) (*ChargeResponse, error)
}
...
func _Charge_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChargeServer).Calculate(ctx, req.(*dtypes.VoidRequest))
	}
...
var fileDescriptor0 = []byte{
	...
	,
}
