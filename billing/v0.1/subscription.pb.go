...
type Subscription struct {
	...
	DateStarted string `protobuf:"bytes,6,opt,name=date_started,json=dateStarted" json:"date_started,omitempty"`
	DateEnded   string `protobuf:"bytes,7,opt,name=date_ended,json=dateEnded" json:"date_ended,omitempty"`
}
...
var fileDescriptor1 = []byte{
	...
	,
}
