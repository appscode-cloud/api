...
type Operation_DbBackupRequest struct {
	DbBackupRequest *db.BackupRequest `protobuf:"bytes,14,opt,name=db_backup_request,json=dbBackupRequest,oneof"`
}
...
func (*Operation_DbBackupRequest) isOperation_Request()         {}
...
func (m *Operation) GetDbBackupRequest() *db.BackupRequest {
	if x, ok := m.GetRequest().(*Operation_DbBackupRequest); ok {
		return x.DbBackupRequest
	}
	return nil
}
...
func _Operation_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Operation_DbBackupRequest:
		b.EncodeVarint(14<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.DbBackupRequest); err != nil {
			return err
		}
	case nil:
	default:
...
func _Operation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 13: // request.data_bucket_delete_request
		...
		return true, err
	case 14: // request.db_backup_request
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(db.BackupRequest)
		err := b.DecodeMessage(msg)
		m.Request = &Operation_DbBackupRequest{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Operation_OneofSizer(msg proto.Message) (n int) {
	...
	case *Operation_DataBucketDeleteRequest:
		...
		n += s
	case *Operation_DbBackupRequest:
		s := proto.Size(x.DbBackupRequest)
...
var fileDescriptor0 = []byte{
	...
	,
}
