...
func dataFilesCiLatestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/ci.latest.json", size: 3266, mode: os.FileMode(436), modTime: time.Unix(1465370754, 0)}
...
func dataFilesConfigsYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/configs.yaml", size: 774, mode: os.FileMode(436), modTime: time.Unix(1465370708, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
