...
func dataFilesCiLatestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/ci.latest.json", size: 3261, mode: os.FileMode(420), modTime: time.Unix(1464353936, 0)}
...
func dataFilesClusterLatestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/cluster.latest.json", size: 489, mode: os.FileMode(420), modTime: time.Unix(1464353936, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataFilesDbLatestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/db.latest.json", size: 4044, mode: os.FileMode(420), modTime: time.Unix(1464353936, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataFilesPkgLatestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/pkg.latest.json", size: 8823, mode: os.FileMode(420), modTime: time.Unix(1464353936, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
