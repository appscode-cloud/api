...
func dataFilesCloud_providerJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/cloud_provider.json", size: 13215, mode: os.FileMode(436), modTime: time.Unix(1467189484, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataFilesConfigsYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/configs.yaml", size: 840, mode: os.FileMode(436), modTime: time.Unix(1467428150, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
