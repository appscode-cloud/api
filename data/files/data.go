...
func dataFilesCiLatestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/ci.latest.json", size: 3266, mode: os.FileMode(436), modTime: time.Unix(1465790467, 0)}
...
func dataFilesConfigsYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/files/configs.yaml", size: 745, mode: os.FileMode(436), modTime: time.Unix(1465790467, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
