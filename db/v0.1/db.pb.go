...
type DescribeResponse struct {
	...
	AutoSnapshot int32          `protobuf:"varint,7,opt,name=auto_snapshot" json:"auto_snapshot,omitempty"`
	LastBackup   string         `protobuf:"bytes,8,opt,name=last_backup" json:"last_backup,omitempty"`
	Kube         *KubeInfo      `protobuf:"bytes,9,opt,name=kube" json:"kube,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
