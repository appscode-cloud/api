...
type DescribeResponse struct {
	...
	LastBackup   string         `protobuf:"bytes,10,opt,name=last_backup,json=lastBackup" json:"last_backup,omitempty"`
	Kube         *KubeInfo      `protobuf:"bytes,11,opt,name=kube" json:"kube,omitempty"`
	DbStatus     string         `protobuf:"bytes,12,opt,name=db_status,json=dbStatus" json:"db_status,omitempty"`
	AuthSecret   string         `protobuf:"bytes,13,opt,name=auth_secret,json=authSecret" json:"auth_secret,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
