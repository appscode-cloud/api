...
type Snapshot struct {
	...
	DbCluster   string `protobuf:"bytes,3,opt,name=db_cluster,json=dbCluster" json:"db_cluster,omitempty"`
	...
	RestoreDb   string `protobuf:"bytes,10,opt,name=restore_db,json=restoreDb" json:"restore_db,omitempty"`
	RestoreSnap string `protobuf:"bytes,11,opt,name=restore_snap,json=restoreSnap" json:"restore_snap,omitempty"`
	Created     string `protobuf:"bytes,12,opt,name=created" json:"created,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
