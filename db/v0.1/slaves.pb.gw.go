...
func request_Slaves_Add_0(ctx context.Context, marshaler runtime.Marshaler, client SlavesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterSlavesHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("PUT", pattern_Slaves_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Slaves_Add_0(runtime.AnnotateContext(ctx, req), inboundMarshaler, client, req, pathParams)
		...
		forward_Slaves_Add_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Slaves_Add_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"appscode", "api", "db", "v0.1", "slave", "cluster"}, ""))
)
