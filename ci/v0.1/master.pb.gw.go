...
func request_Master_Create_0(ctx context.Context, client MasterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterMasterHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("PUT", pattern_Master_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Master_Create_0(runtime.AnnotateContext(ctx, req), client, req, pathParams)
		...
		forward_Master_Create_0(ctx, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Master_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ci", "v0.1", "master"}, ""))

	pattern_Master_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ci", "v0.1", "master"}, ""))
)
