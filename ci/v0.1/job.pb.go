...
type JobDescribeResponse struct {
	...
	BuildCount    int64          `protobuf:"varint,6,opt,name=build_count,json=buildCount" json:"build_count,omitempty"`
	JobColor      string         `protobuf:"bytes,7,opt,name=job_color,json=jobColor" json:"job_color,omitempty"`
	BuildsCommand string         `protobuf:"bytes,8,opt,name=builds_command,json=buildsCommand" json:"builds_command,omitempty"`
}
...
var fileDescriptor2 = []byte{
	...
	,
}
